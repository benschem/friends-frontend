  ...
  return(
    <div class="mx-4 grow">
      ...
      <div class="my-4 grid grid-cols-2 gap-4">
        <A href="/friends" class="p-4 text-center rounded-lg border-2 shadow-lg cursor-pointer font-roboto text-sm font-bold bg-blue-chill-300 dark:bg-blue-chill-700 text-blue-chill-700 dark:text-blue-chill-50">
          Login
        </A>
        <A href="/friends" class="p-4 text-center rounded-lg border-2 shadow-lg cursor-pointer font-roboto text-sm font-bold bg-blue-chill-300 dark:bg-blue-chill-700 text-blue-chill-700 dark:text-blue-chill-50">
          Signup
